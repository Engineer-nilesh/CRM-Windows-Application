...
namespace GSTEducationalCRMSoft
{
    public partial class frmNewAdmission : Form
    {
        ...
        public frmNewAdmission(string studcode)
        {
            StudCode = studcode;
            InitializeComponent();
            btnRegister.Hide();
            Counsellor objEnquiryToAdmission = new Counsellor(StudCode);
            SqlDataReader CandidateReader = objEnquiryToAdmission.GetStudentDetailsForUpdate();
            ...
            if (CandidateReader.HasRows)
            {
                ...
                dtEnquiryDate.Text = CandidateReader["StudEnquiryDate"].ToString();
                //StatusId = CandidateReader["StatusId"].ToString();
        ...
        private void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {   
                    ...
                    {
                        StudFullName = txtFirstName.Text + " " + txtLastName.Text;
                    }
                    else
                    {
                    ...
                    {
                        SSCYear = Convert.ToInt32(txtHSCYear.Text);
                    }
                    if (txtSSCYear.Text == "")
                    {
                        HSCYear = 0;
                    ...
                    {
                        HSCYear = Convert.ToInt32(txtSSCYear.Text);
                    }
                    ...
                    {
                        DiplomaYear = Convert.ToInt32(txtDiplomaYear.Text);
                    }
                    ...
                    Counsellor objInsertcandidate = new Counsellor(StudCode,
                        StudFullName,
                        txtContactNo.Text,
                        txtAlternateNo.Text,
                        txtEmail.Text,
                    ...
                    objInsertcandidate.InsertCandidate();
                    objInsertcandidate.UpdateQualification();
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            else if (string.IsNullOrEmpty(txtContactNo.Text) == true && txtContactNo.Text.Length >= 10 && txtContactNo.Text.Length <= 16)
            {
                txtContactNo.Focus();
                erPContactNo.SetError(txtContactNo, "Contact Number should be in correct form and not Empty");
                MessageBox.Show("Contact Number should be in correct form and not Empty");
                erPContactNo.Clear();
            }

            else if (string.IsNullOrEmpty(txtAlternateNo.Text) == true && txtAlternateNo.Text.Length >= 10 && txtAlternateNo.Text.Length <= 16)
            {
                txtAlternateNo.Focus();
                erPAlternateNo.SetError(txtAlternateNo, "Alternate Number should be in correct form and not Empty");
                MessageBox.Show("Alternate Number should be in correct form and not Empty");
                erPAlternateNo.Clear();
            }
            ...
            else
            {
                try
                {
                    ...
                    objInsertcandidate.UpdateCandidate();
                    objInsertcandidate.UpdateQualification();
                    MessageBox.Show("Student Added!!!");
                    this.Close();
                }
        ...
        //    {
        //        MessageBox.Show("Please Enter correct SSC Year");
        //    }
        //}
        ...
        //    {
        //        MessageBox.Show("Please Enter correct HSC Year");
        //    }
        //}
        ...
        //    {
        //        MessageBox.Show("Please Enter correct Diploma Year");
        //    }
        //}
        ...
        private void txtDiplomaYear_Leave(object sender, EventArgs e)
        {
            if (txtDiplomaYear.Text.Length != 4)
            {
                ...
                erPDiplomaYear.SetError(txtDiplomaYear, "Invalid Graduation Year");
        ...
        {
            if (string.IsNullOrEmpty(StudCode) == false)
            {
            ...
            {
                Counsellor objCheckExisting = new Counsellor(txtEmail.Text);
        ...
        {
            if (!Regex.IsMatch(txtGraduationYear.Text, @"^[0-9]+$"))
            {
        ...
        //{
        //    if (!Regex.IsMatch(txtPGYear.Text, @"^[0-9]+$"))
        //    {
        //        txtPGYear.Focus();
        ...
        private void txtGraduationYear_TextChanged_1(object sender, EventArgs e)
        {
        ...
        private void txtDiplomaYear_TextChanged_1(object sender, EventArgs e)
        {
        ...
        private void txtDiplomaYear_Leave_1(object sender, EventArgs e)
        {
            if(txtDiplomaYear.Text.Length != 4)
            {
                MessageBox.Show("Invalid Diploma Year");
        ...
        private void txtGraduationYear_Leave_1(object sender, EventArgs e)
        {
            if(txtGraduationYear.Text.Length != 4)
            {
                MessageBox.Show("Invalid Graduation Year");
        ...
        private void txtPGYear_TextChanged_1(object sender, EventArgs e)
        {
        ...
        private void txtPGYear_Leave_1(object sender, EventArgs e)
        {
        ...
        {
            if (!string.IsNullOrEmpty(txtContactNo.Text) == true)
            {
                Counsellor objCheckExistingPhone = new Counsellor(txtContactNo.Text);
                SqlDataReader dr = objCheckExistingPhone.CheckExistingCandidatePhone();
                dr.Read();
                if (dr.HasRows)
                {
                    txtContactNo.Focus();
                    erPContactNo.SetError(txtContactNo, "Phone Number already Exists");
